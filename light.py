...
from .feicanled import FeicanledInstance
...
async def async_setup_entry(hass, config_entry, async_add_devices):
    ...
    async_add_devices([FeicanledLight(instance, config_entry.data["name"], config_entry.entry_id)])

class FeicanledLight(LightEntity):
    def __init__(self, feicanledInstance: FeicanledInstance, name: str, entry_id: str) -> None:
        self._instance = feicanledInstance
